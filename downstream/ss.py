...
def main():
    ...
    raw_datasets = load_dataset("EMBO/BLURB", args.task_name)
    ...
    config = AutoConfig.from_pretrained(args.model_name_or_path, num_labels=num_labels, finetuning_task=args.task_name, revision=args.revision)
    ...
    train_dataset = processed_datasets.select(range(64))
    eval_dataset = processed_datasets.select(range(65, 80))
