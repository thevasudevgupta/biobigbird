...
def main():
    ...
    raw_datasets = load_dataset("ddp-iitm/ebm_pico")
    ...
    def tokenize_and_align_labels(examples):
        ...
        for word_idx in word_ids:
            if word_idx is None:
                ...
                continue
            try:
                ok = model.config.label2id.get(labels[word_idx], -100)
            except:
                print(word_idx, len(labels))
                exit()
            final_labels.append(ok)
